...
pub enum GateKind {
    ...
    Rx, Ry, Rz, Phase, U3,
    // Two-qubit
    CNOT, CZ, CY, SWAP, ISWAP, CRz, CP, RZZ, ECR, MS,
    // Three-qubit
    Toffoli, Fredkin,
}
...
impl GateKind {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            GateKind::SX => "SX", GateKind::Rx => "Rx", GateKind::Ry => "Ry",
            GateKind::Rz => "Rz", GateKind::Phase => "Phase", GateKind::U3 => "U3",
            GateKind::CNOT => "CNOT", GateKind::CZ => "CZ", GateKind::CY => "CY",
            GateKind::SWAP => "SWAP", GateKind::ISWAP => "iSWAP",
            GateKind::CRz => "CRz", GateKind::CP => "CP", GateKind::RZZ => "RZZ",
    ...
    pub fn is_single(&self) -> bool {
        matches!(self, GateKind::I | GateKind::X | GateKind::Y | GateKind::Z |
                 ...
                 GateKind::Rz | GateKind::Phase | GateKind::U3)
    }

    pub fn is_parametric(&self) -> bool {
        matches!(self, GateKind::Rx | GateKind::Ry | GateKind::Rz |
                 GateKind::Phase | GateKind::U3 | GateKind::CRz |
                 GateKind::CP | GateKind::RZZ)
    }
}
...
pub fn apply_three_qubit(sv: &mut SparseStateVec, gate: &GateOp) {
    match gate.kind {
        GateKind::Toffoli => apply_toffoli(sv, gate.qubits[0], gate.qubits[1], gate.qubits[2]),
...
pub fn apply_gate(sv: &mut SparseStateVec, gate: &GateOp) {
    match gate.qubits.len() {
        ...
        _ => panic!("Gates on >3 qubits not supported directly"),
    }
}
